...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', default='/data/dataset/I2I_equ', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0 s 0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--name', type=str, default='CycleGAN(nighttime-1GPU)', help='name of the experiment. It decides where to store samples and models')
